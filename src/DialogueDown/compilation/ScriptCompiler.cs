...
/// desugar, validate, analyze — in order, threading a <see cref="DiagnosticsContext"/> (the source
/// plus a per-compilation <see cref="DiagnosticBag"/>) through each so a stage can anchor and
/// report a diagnostic, and assembles their artifacts into a <see cref="CompilationResult"/>.
/// </summary>
internal sealed class ScriptCompiler : IScriptCompiler
{
    ...
    public CompilationResult Compile(string source)
    {
        ...
        _validator.Validate(desugared, context.Diagnostics);
