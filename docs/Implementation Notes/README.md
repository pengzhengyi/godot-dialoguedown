...
| [Graph Position Preservation](./Graph%20Position%20Preservation.md) | Each stage's graph remembers its zoom, pan, and fold state across tab switches and hot-reloads | Proposed |
