...
/// mode, and root can be chosen in the browser, and stays up until cancelled. Injected so
...
public interface ILauncherRunner
{
    ...
    /// <paramref name="cancellationToken"/> is cancelled. Returns a process exit code.
    /// </summary>
    Task<int> RunAsync(
        string root,
        string? source,
